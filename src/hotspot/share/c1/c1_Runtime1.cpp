...
JRT_ENTRY(void, Runtime1::monitorexit_java(JavaThread* current, oopDesc* obj, BasicObjectLock* lock))
  ...
  ObjectSynchronizer::java_exit(Handle(current, obj), lock, current);
JRT_END
