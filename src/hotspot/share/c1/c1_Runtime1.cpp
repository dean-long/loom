...
JRT_ENTRY(void, Runtime1::monitorexit_java(JavaThread* current, oopDesc* obj, int monitor_index, oopDesc* exc))
  ...
  ObjectSynchronizer::compiled_java_exit(Handle(current, obj), monitor_index, Handle(current, exc), current);
JRT_END
