...
#define VM_INTRINSICS_DO(do_intrinsic, do_class, do_name, do_signature, do_alias)                                       \
  ...
  do_intrinsic(_fillInLockRecord,         java_lang_Object,     fillInLockRecord_name, fillInLockRecord_signature, F_SN) \
   do_name(     fillInLockRecord_name,                         "fillInLockRecord")                                      \
   do_signature(fillInLockRecord_signature,                    "(ILjava/lang/Object;I)V")                               \
